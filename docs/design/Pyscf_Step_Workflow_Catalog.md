...
**Primary Authoritative Source**: PySCF Tutorial (`/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/user_guide.ipynb` and `dev_guide.ipynb`)
...
**Example Test Systems with Golden Reference Values** (from PySCF Tutorial: `/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/`):
...
- **PySCF Tutorial Repository**: `/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/`
...
- **PySCF examples directory**: `/Users/kfranke/QMatSuite/.tmp/pyscf-master/examples/`
