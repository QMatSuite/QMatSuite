...
- **Numeric Validation Tests**:
  ...
  - **Reference**: `/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/user_guide.ipynb`
...
- **Reference**: PySCF Tutorial at `/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/`
...
- **Reference**: PySCF Tutorial at `/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/user_guide.ipynb`
...
- For each MAJOR CATEGORY (scf, mp2, td, freq):
  ...
  - **Primary Reference**: PySCF Tutorial (`/Users/kfranke/QMatSuite/.tmp/PySCF_Tutorial-master/user_guide.ipynb` and `dev_guide.ipynb`)
