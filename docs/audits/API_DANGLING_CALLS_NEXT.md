...
|------|---------------|-------|-------|-------|
| 1 | `quantumvitas.api.QVService::init_project` | 97 | 39 | Static method - exists but scanner missed it |
| 2 | `quantumvitas.api.QVService::init_calculation` | 78 | 36 | Static method - exists but scanner missed it |
| 3 | `quantumvitas.api.QVService::import_structure` | 67 | 29 | Static method - exists but scanner missed it |
| 4 | `quantumvitas.api.QVService::init_step` | 43 | 13 | Static method - exists but scanner missed it |
| 5 | `quantumvitas.api.QVService::add_step` | 31 | 11 | Likely `svc.calculation.add_step()` - nested class method |
| 6 | `quantumvitas.api.QVService::update_step_params` | 25 | 14 | Likely `svc.calculation.update_step_params()` - nested class method |
| 7 | `quantumvitas.api.QVService::is_ulid_like` | 22 | 1 | Utility function - should move to utils |
| 8 | `quantumvitas.api.QVService::run_step` | 20 | 8 | Static method - exists but scanner missed it |
| 9 | `quantumvitas.api.QVService::get_pseudo_config` | 15 | 2 | Static method - exists but scanner missed it |
| 10 | `quantumvitas.api_legacy.QVService::_build_structure_vis_payload` | 13 | 5 | Private method in legacy - test-only usage |

**Total dangling calls:** 773 (Note: Many are false positives due to static method detection limitations)
**Total legacy imports:** 8
**Critical legacy imports in new API:** 0 (good - no legacy dependencies in `src/quantumvitas/api/*`)

---

## 1. Inventory of API-like Classes

### quantumvitas.api.service.QVService
...
### quantumvitas._api_legacy.QVService
...
### quantumvitas.api_legacy.QVService
...
**Note:** Many entries in this section are false positives due to static method detection limitations. Methods like `init_project`, `init_calculation`, `import_structure`, etc. are static methods that DO exist in `quantumvitas.api.service.QVService` but were not properly detected by the AST scanner. These should be verified manually.

**Also note:** Some calls may be to nested class methods (e.g., `svc.calculation.add_step()` appears as `QVService::add_step`). These are legitimate calls that need better resolution in the scanner.

### `quantumvitas.api.QVService::init_project`

- **Count:** 97
- **Files:** 39

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2027` (in _handle_create_project)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2083` (in _handle_create_project)
...
### `quantumvitas.api.QVService::init_calculation`

- **Count:** 78
- **Files:** 36

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2716` (in _handle_create_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2801` (in _handle_create_calculation)
...
### `quantumvitas.api.QVService::import_structure`

- **Count:** 67
- **Files:** 29

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2066` (in _handle_import_structure)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2122` (in _handle_import_structure)
...
### `quantumvitas.api.QVService::init_step`
...
### `quantumvitas.api.QVService::add_step`
...
### `quantumvitas.api.QVService::update_step_params`

- **Count:** 25
- **Files:** 14

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3187` (in _handle_update_step_params)
...
### `quantumvitas.api.QVService::is_ulid_like`

- **Count:** 22
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2905` (in _handle_can_delete_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2986` (in _handle_delete_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2989` (in _handle_delete_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3098` (in _handle_get_step_detail)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3179` (in _handle_update_step_params)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3258` (in _handle_get_common_cards)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3302` (in _handle_set_common_card)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3342` (in _handle_get_pseudo_mapping)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3386` (in _handle_set_pseudo_mapping)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3545` (in _handle_reset_step_params)
*... and 12 more callsites*

### `quantumvitas.api.QVService::run_step`

- **Count:** 20
- **Files:** 8

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:1744` (in run_step_command)
...
### `quantumvitas.api.QVService::get_pseudo_config`

- **Count:** 15
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:748` (in _handle_get_pseudo_config)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1198` (in _handle_list_pseudo_archives_status)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1252` (in _handle_install_pseudo_archive)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:748` (in _handle_get_pseudo_config)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:788` (in _handle_validate_pseudo_config)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:807` (in _handle_init_pseudo_dirs)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:829` (in _handle_install_seed_to_store)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:872` (in _handle_list_installed_sssp)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:897` (in _handle_list_seed_archives)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:940` (in _handle_download_sssp_library)
...
### `quantumvitas.api.QVService::run_calculation`

- **Count:** 12
- **Files:** 5

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:3997` (in run_calculation_command)
...
### `quantumvitas.api.QVService::promote_relax_structure`

- **Count:** 12
- **Files:** 5

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3159` (in _handle_promote_relax_structure)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3218` (in _handle_promote_relax_structure)
...
### `quantumvitas.api.QVService::list_calculations_data`

- **Count:** 11
- **Files:** 4

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1973` (in _handle_list_calculations)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2726` (in _handle_create_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2030` (in _handle_list_calculations)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2811` (in _handle_create_calculation)
...
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:92` (in test_returns_list)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:102` (in test_calculation_entry_schema)
*... and 1 more callsites*

### `quantumvitas.api.QVService::list_structures_data`

- **Count:** 9
- **Files:** 4

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1960` (in _handle_list_structures)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2074` (in _handle_import_structure)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2016` (in _handle_list_structures)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2130` (in _handle_import_structure)
...
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:55` (in test_returns_list)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:67` (in test_structure_entry_schema)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:258` (in test_structures_list_serializable)

### `quantumvitas.api.QVService::get_project_summary`

- **Count:** 8
- **Files:** 4

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1948` (in _handle_get_project_summary)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2039` (in _handle_create_project)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2006` (in _handle_get_project_summary)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2095` (in _handle_create_project)
- `<HOME>/QMatSuite/tests/unit/test_demo_snapshot_restore.py:140` (in test_create_demo_project_via_api)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:22` (in test_returns_project_info)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:41` (in test_counts_resources)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:247` (in test_project_summary_serializable)

### `quantumvitas.api.QVService::validate_ulid`

- **Count:** 7
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2911` (in _handle_delete_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:4328` (in _handle_get_calculation_pseudo_mapping)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3003` (in _handle_delete_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3115` (in _handle_get_step_detail)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4125` (in _handle_get_calculation_detail)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4403` (in _handle_get_calculation_pseudo_mapping)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4577` (in _handle_get_pseudo_options_for_calculation)

### `quantumvitas.api.QVService::create_demo_project`

- **Count:** 7
- **Files:** 5

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:4582` (in _handle_create_demo_project)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4678` (in _handle_create_demo_project)
...
### `quantumvitas.api.QVService::get_vis_data`

- **Count:** 7
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:129` (in test_returns_visualization_data)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:172` (in test_supercell_increases_atoms)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:173` (in test_supercell_increases_atoms)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:184` (in test_boundary_repeat_adds_image_atoms)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:190` (in test_boundary_repeat_adds_image_atoms)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:236` (in test_not_found_raises_error)
- `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py:280` (in test_structure_vis_serializable)

### `quantumvitas.api.QVService::configure_step`
...
### `quantumvitas.api.service.QVService::load_artifact`
...
### `quantumvitas.api.QVService::get_workflow_service`

- **Count:** 5
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:6248` (in _handle_list_workflow_templates)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:6282` (in _handle_detect_workflow)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:6365` (in _handle_detect_workflow_for_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:6436` (in _handle_instantiate_workflow)
- `<HOME>/QMatSuite/tests/unit/test_api_service_facade.py:178` (in test_get_workflow_service_wrapper)

### `quantumvitas.api.QVService::get_band_structure_data`

- **Count:** 5
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4859` (in _handle_get_band_structure_data)
...
### `quantumvitas.api.service.QVService::validate_installation`
...
### `quantumvitas.api.QVService::configure_species_map`

- **Count:** 4
- **Files:** 4

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:3643` (in configure_species_command)
...
### `quantumvitas.api.QVService::get`

- **Count:** 4
- **Files:** 3

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:5293` (in _validate_step_structure_consistency)
...
### `quantumvitas.api.QVService::require_ref`

- **Count:** 4
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:5301` (in _validate_step_structure_consistency)
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:5353` (in _execute_step_spec)
...
### `quantumvitas.api.QVService::get_settings`

- **Count:** 4
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:191` (in __init__)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1374` (in _handle_get_debug_resolution)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2996` (in _handle_get_step_detail)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:4295` (in _handle_get_calculation_pseudo_mapping)

### `quantumvitas.api.QVService::load_pseudo_config`

- **Count:** 4
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:815` (in _handle_install_seed_to_store)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:871` (in _handle_list_seed_archives)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:957` (in _handle_download_all_sssp)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1001` (in _handle_import_seed_archives)

### `quantumvitas.api.QVService::can_delete_structure`

- **Count:** 4
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2647` (in _handle_can_delete_structure)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:2666` (in _handle_delete_structure)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2721` (in _handle_can_delete_structure)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:2740` (in _handle_delete_structure)

### `quantumvitas.api.QVService::download_pseudo_by_filename`

- **Count:** 4
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3408` (in _handle_download_pseudo_by_filename)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3448` (in _handle_download_pseudo_candidate)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3477` (in _handle_download_pseudo_by_filename)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3517` (in _handle_download_pseudo_candidate)

### `quantumvitas.api.QVService::save_relax_final_structure`

- **Count:** 4
- **Files:** 3

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3549` (in _handle_save_relax_final_structure)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:3619` (in _handle_save_relax_final_structure)
...
### `quantumvitas.api.service.QVService::duplicate`
...
### `QVService.init_calculation::is_dir`
...
### `quantumvitas.api.QVService::get_default_step_params`

- **Count:** 3
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:1270` (in init_step_command)
...
### `quantumvitas.api.QVService::run_input_step`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:1881` (in _run_standalone_step)
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:1959` (in run_structure_command)
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:5383` (in _execute_step_spec)

### `quantumvitas.api.QVService::list_installed_sssp`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:854` (in _handle_list_installed_sssp)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:934` (in _handle_download_sssp_library)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:976` (in _handle_download_all_sssp)

### `quantumvitas.api.QVService::check_archives_status`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1200` (in _handle_list_pseudo_archives_status)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1287` (in _handle_install_pseudo_archive)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:1313` (in _handle_install_pseudo_archive)

### `quantumvitas.api.QVService::detect_engine_for_calculation`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3677` (in _handle_detect_presets)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3787` (in _handle_apply_presets_to_step)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3946` (in _handle_apply_presets_to_calculation)

### `quantumvitas.api.QVService::detect_presets_from_calculation`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3682` (in _handle_detect_presets)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3788` (in _handle_apply_presets_to_step)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:3947` (in _handle_apply_presets_to_calculation)

### `quantumvitas.api.QVService::import_step_from_qe_input`

- **Count:** 3
- **Files:** 3

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:4154` (in _handle_import_step_from_qe_input)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4232` (in _handle_import_step_from_qe_input)
- `<HOME>/QMatSuite/tools/import_tutorial_datasets.py:562` (in _materialize_project_from_input_folder_legacy)

### `quantumvitas.api.QVService::get_calculation_pseudo_mapping`

- **Count:** 3
- **Files:** 3

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:4332` (in _handle_get_calculation_pseudo_mapping)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4407` (in _handle_get_calculation_pseudo_mapping)
- `<HOME>/QMatSuite/tools/test_silicon_wannier90_demo_logging.py:85` 

### `quantumvitas.api.QVService::create_blob_store`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:5119` (in _handle_compile_fixture_volume)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:5142` (in _handle_compile_fixture_volume)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:5163` (in _handle_compile_fixture_volume)

### `quantumvitas.api.QVService::load_calculation`

- **Count:** 3
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:5235` (in _handle_run_calculation)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:5323` (in _handle_run_step)
- `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py:5863` (in _snapshot_dag)

### `quantumvitas.api.QVService::get_calculation_detail`

- **Count:** 3
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4130` (in _handle_get_calculation_detail)
- `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py:4589` (in _handle_get_pseudo_options_for_calculation)
- `<HOME>/QMatSuite/tools/import_tutorial_datasets.py:944` (in validate_roundtrip_regeneration)

### `quantumvitas.api.service.QVService::list`
...
### `quantumvitas.api.service.QVService::cancel`
...
### `QVService.promote_relax_structure::exists`
...
### `quantumvitas.api.QVService::create_default_registry`

- **Count:** 2
- **Files:** 1

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:1536` (in detect_qe)
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:1927` (in run_structure_command)

### `quantumvitas.api.QVService::analyze_band`

- **Count:** 2
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:4569` (in analyze_band_command)
- `<HOME>/QMatSuite/tests/daemon/test_si_bands_calculation_daemon.py:459` (in test_analyze_bands_and_generate_plot)

### `quantumvitas.api.QVService::get_config`

- **Count:** 2
- **Files:** 2

**Callsites:**
- `<HOME>/QMatSuite/src/quantumvitas/cli/main.py:5281` (in _validate_step_structure_consistency)
...
**Status:** ✅ **No critical legacy imports found in `src/quantumvitas/api/*`**
...
- Line 24: `from quantumvitas.api_legacy import QVService`

#### `tests/integration/test_optimade_live.py`
- Line 496: `from quantumvitas.api_legacy import QVService` (inside function)

#### `tests/unit/test_online_project_payload_contract.py`
- Line 14: `from quantumvitas.api_legacy import QVService`

#### `tests/unit/test_online_structure_supercell.py`
- Line 403: `from quantumvitas.api_legacy import QVService` (inside function)
- Line 542: `from quantumvitas.api_legacy import QVService` (inside function)

#### `tests/unit/test_optimade_offline.py`
- Line 21: `from quantumvitas.api_legacy import QVService`

**Summary:**
- **Total legacy imports:** 8 (all in test files)
- **Critical imports in new API:** 0 ✅
- **Action:** These test files should be migrated to use `quantumvitas.api.QVService` instead of `quantumvitas.api_legacy.QVService`

---

## 5. Migration Decision Table

### Category A: Should migrate to new QVService domain accessor

#### `quantumvitas.api.QVService::get_pseudo_config`

- **Count:** 15
- **Rationale:** Should migrate to new QVService domain accessor
- **Proposed action:** See rationale above

- **Sample files:** `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/tools/import_tutorial_datasets.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/src/quantumvitas/cli/main.py`

#### `quantumvitas.api.QVService::get_environment_info`
...
#### `quantumvitas.api.QVService::list_qe_engines`
...
#### `quantumvitas.api.QVService::delete_structure`
...
#### `quantumvitas.api.QVService::get_pseudo_mapping`
...
#### `quantumvitas.api.QVService::get_relax_final_structure_preview`
...
#### `quantumvitas.api.QVService::update_calculation_species_map`
...
#### `quantumvitas.api.QVService::list_demo_projects`
...
#### `quantumvitas.api.QVService::get_dos_data`
...
#### `quantumvitas.api.QVService::get_reference_analysis`
...
#### `quantumvitas.api.QVService::list_step_artifacts`
...
#### `quantumvitas.api.QVService::get_journal`
...
#### `quantumvitas.api.QVService::create_project_from_snapshot`
...
#### `QVService.create_default_registry::get`
...
#### `quantumvitas.api.QVService::get_qe_home`
...
- **Sample files:** `<HOME>/QMatSuite/tools/import_tutorial_datasets.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
#### `quantumvitas.api.QVService::detect_qe`
...
#### `quantumvitas.api.QVService::discover_qe_engines`
...
#### `quantumvitas.api.QVService::set_qe_engine`
...
#### `quantumvitas.api.QVService::set_pseudo_config`
...
#### `quantumvitas.api.QVService::resolve_pseudo_provenance`
...
#### `quantumvitas.api.QVService::load_manifest_archives`
...
#### `quantumvitas.api.QVService::rename_structure`
...
#### `quantumvitas.api.QVService::rename_calculation`
...
#### `QVService.promote_relax_structure::relative_to`
...
#### `quantumvitas.api.QVService::set_common_card`
...
- **Sample files:** `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`
...
#### `quantumvitas.api.QVService::parse_volume_artifact`
...
#### `quantumvitas.api.QVService::generate_kpath`
...
#### `quantumvitas.api.QVService::generate_unique_name_and_slug`
...
#### `quantumvitas.api.QVService::meta_from_name`
...
- **Sample files:** `<HOME>/QMatSuite/tests/integration/test_qe_relax_real.py`, `<HOME>/QMatSuite/src/quantumvitas/cli/main.py`, `<HOME>/QMatSuite/tests/integration/vasp/test_vasp_project_e2e.py`, `<HOME>/QMatSuite/tests/integration/orca/test_orca_project_level.py`, `<HOME>/QMatSuite/tests/integration/test_pyscf_phase3c.py`
...
- **Sample files:** `<HOME>/QMatSuite/src/quantumvitas/cli/main.py`, `<HOME>/QMatSuite/tests/integration/vasp/test_vasp_project_e2e.py`, `<HOME>/QMatSuite/tests/integration/orca/test_orca_project_level.py`, `<HOME>/QMatSuite/tests/integration/test_incremental_run.py`, `<HOME>/QMatSuite/tests/integration/test_pyscf_phase3c.py`
...
- **Sample files:** `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`, `<HOME>/QMatSuite/tests/daemon/test_promote_relax_structure.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/tests/integration/test_relax_e2e.py`, `<HOME>/QMatSuite/tests/integration/test_relax_promote_e2e.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/daemon/test_gui_calculation_detail.py`, `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py`, `<HOME>/QMatSuite/tests/integration/test_relax_promote_e2e.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py`, `<HOME>/QMatSuite/tests/unit/test_demo_snapshot_restore.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/unit/test_api_service.py`, `<HOME>/QMatSuite/tests/unit/test_demo_snapshot_restore.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`, `<HOME>/QMatSuite/tests/unit/test_project_snapshot.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/unit/test_qvservice_gui.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/unit/test_api_service_facade.py`, `<HOME>/QMatSuite/src/quantumvitas/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/unit/test_api_get_band_structure_data.py`, `<HOME>/QMatSuite/src/quantumvitas/frontends/daemon/server.py`
...
- **Sample files:** `<HOME>/QMatSuite/tests/daemon/test_gui_job_and_step_flows.py`, `<HOME>/QMatSuite/tests/integration/test_qe_relax_real.py`, `<HOME>/QMatSuite/tests/daemon/test_si_bands_calculation_daemon.py`, `<HOME>/QMatSuite/src/quantumvitas/cli/main.py`
