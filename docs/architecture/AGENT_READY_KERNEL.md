...
**Key files to read**:
- `<HOME>/repo_research/LangSim/langsim/tools/simulation_atomistics.py:1-500` - Core tool implementations
- `<HOME>/repo_research/LangSim/langsim/llm.py:1-200` - LLM client wrapper
- `<HOME>/repo_research/LangSim/langsim/magics.py:1-300` - Jupyter integration
- `<HOME>/repo_research/LangSim/langsim/__init__.py` - Public API surface
- `<HOME>/repo_research/LangSim/README.md` - Usage patterns
...
**Key files to read**:
- `<HOME>/repo_research/aiida-core/src/aiida/orm/nodes/node.py:1-300` - Core Node abstraction
- `<HOME>/repo_research/aiida-core/src/aiida/engine/processes/process.py:1-400` - Process execution model
- `<HOME>/repo_research/aiida-core/src/aiida/engine/processes/calcjobs/calcjob.py:217-638` - CalcJob implementation
- `<HOME>/repo_research/aiida-core/src/aiida/storage/psql_dos/models/node.py:1-200` - Database schema
- `<HOME>/repo_research/aiida-core/src/aiida/engine/processes/workchains/workchain.py:1-200` - Workflow definition
...
**Key files to read**:
- `<HOME>/repo_research/material_agent/src/planNexe2.py:260-421` - Graph construction and agent nodes
- `<HOME>/repo_research/material_agent/src/tools.py:1-400` - Tool implementations (inspect_my_canvas, write_QE_script, etc.)
- `<HOME>/repo_research/material_agent/src/prompt.py:1-180` - Agent prompts defining capabilities
- `<HOME>/repo_research/material_agent/README.md` - Architecture overview
...
**Key files to read**:
- `<HOME>/repo_research/VASPilot/src/vaspilot/tools/mcp/mcp_server.py:89-470` - MCP tool implementations
- `<HOME>/repo_research/VASPilot/src/vaspilot/tools/mcp/vasp_calculate.py:15-436` - VASP submission logic
- `<HOME>/repo_research/VASPilot/src/vaspilot/crew/vasp_crew.py:21-176` - CrewAI setup
- `<HOME>/repo_research/VASPilot/README.md` - Overview and usage
...
- **Citation**: `<HOME>/repo_research/aiida-core/src/aiida/orm/nodes/node.py` (immutable Node model)
...
- **Citation**: `<HOME>/repo_research/material_agent/src/planNexe2.py:45-50` (PlanExecute state)
...
- **Citation**: `<HOME>/repo_research/VASPilot/src/vaspilot/tools/mcp/mcp_server.py:59-88`
