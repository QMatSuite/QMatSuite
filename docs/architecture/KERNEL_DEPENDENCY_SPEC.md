...
**Version**: 3.1
**Date**: 2026-02-03
**Parent Law**: `CONSTITUTION_ZH.md` (repo-root)

---

## 0. Constitution Alignment

This spec extends and refines rules from the repo-root `CONSTITUTION_ZH.md`. The following clauses are directly relevant:
