...
This is an exploration utility for understanding Gaussian output structure.

Tested against smoke_tests/ artifacts:
- water_sp.log (HF single point)
- water_opt.log (B3LYP optimization)
- water_opt_freq.log (HF opt + frequency)
- ethylene_mp2.log (MP2 single point)
- formaldehyde_tddft.log (TDDFT excited states)
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python gaussian_parser.py <log_file>")
        sys.exit(1)
