...
| Path | Purpose |
|------|---------|
| `src/qmatsuite/demo_store/translator.py` | Core translator: corpus case -> ProjectSnapshot |
| `src/qmatsuite/demo_store/corpus.py` | Corpus index loader and validator |
| `src/qmatsuite/demo_store/ulid_seed.py` | Deterministic ULID generation |
| `src/qmatsuite/demo_store/roundtrip.py` | Roundtrip equivalence checker |
| `src/qmatsuite/demo_store/direct_snapshot.py` | Builder for Python-script engines |
| `src/qmatsuite/demo_store/manifest.py` | Generator manifest reader/writer |
