...
- `test_rename_calculation_across_directories_updates_all_references`: 跨目录重命名工作流时，所有引用（project.qms.yml、calculation.yaml）正确更新。
