...
def _load_raw_metadata() -> Dict[str, Any]:
    ...
    If ``QV_ABINIT_METADATA_HOT_RELOAD=1`` is set, checks file mtime and
    ...
    hot_reload = os.environ.get("QV_ABINIT_METADATA_HOT_RELOAD", "").strip() == "1"
    ...
    try:
        ...
        raise FileNotFoundError(
            "abinit_tags.json is missing from quantumvitas.drivers.abinit.data."
        ) from exc
