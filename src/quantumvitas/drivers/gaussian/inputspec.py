...
Supports both writing and parsing (roundtrip) of Gaussian input files.
...
def _parse_route_keywords(route_text: str) -> dict[str, Any]:
    ...
    for tok in tokens:
        ...
        if base_upper in ("G1", "G2", "G2MP2", "G3", "G3MP2", "G3B3",
                          "G3MP2B3", "G4", "G4MP2", "CBS-QB3", "W1U", "W1BD"):
            params["method"] = base
...
def _parse_gaussian_text(text: str) -> dict[str, Any]:
    ...
    if route_lines:
        ...
        route_params = _parse_route_keywords(route_text)
    ...
    return EngineInputSpec(
        ...
        input_files=(
            InputFileSpec(
                ...
                custom_parser=_parse_gaussian_text,
            ),
        ),
        resource_refs=(
            ResourceRefSpec(
