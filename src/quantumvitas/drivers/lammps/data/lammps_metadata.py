...
def _load_raw_metadata() -> Dict[str, Any]:
    ...
    If ``QV_LAMMPS_METADATA_HOT_RELOAD=1`` is set, checks file mtime and
    ...
    hot_reload = os.environ.get("QV_LAMMPS_METADATA_HOT_RELOAD", "").strip() == "1"
    ...
    try:
        ...
        raise FileNotFoundError(
            "lammps_commands.json is missing from quantumvitas.drivers.lammps.data."
        ) from exc
