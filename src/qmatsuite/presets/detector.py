...
def _detect_dimension(
    ...
    """
    from qmatsuite.presets.spaces_registry import detect_dimension as registry_detect
    ...
    for step_params, step_type_gen in zip(steps, step_types_gen):
        ...
        if dimension == DIMENSION_PRECISION and calculation_dir:
            try:
                ...
                from qmatsuite.presets.precision import aggregate_cutoffs
...
def _detect_precision_from_steps_strict(
    ...
    try:
        from qmatsuite.presets.precision_context import (
...
def _match_precision_without_kpoints(
    ...
    """
    from qmatsuite.presets.paramspace import get_precision_paramspace, get_yaml_value
