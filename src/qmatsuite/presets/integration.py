...
def _detect_engine_for_calculation(calculation_dir: Path) -> Optional[str]:
    ...
    """
    from qmatsuite.presets.capability import resolve_engine_for_step
...
def _load_step_parameters(
    ...
    *,
    ...
    """
    from qmatsuite.presets.receivers import is_receiver
...
def apply_presets_to_step(
    ...
    *,
    ...
    from qmatsuite.presets.capability import resolve_engine_for_step, require_preset_capability, CapabilityError
    ...
    for dimension in dependent_dimensions:
        ...
        if dimension == DIMENSION_PRECISION and precision_advice is not None:
            ...
            if base_ecutwfc is None or base_ecutrho is None:
                from qmatsuite.presets.precision import PRECISION_CONSTANTS
