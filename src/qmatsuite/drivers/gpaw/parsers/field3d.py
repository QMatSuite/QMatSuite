"""GPAW field3d analysis provider (cube from ASE cube writer)."""
...
def _detect_field_kind(name: str) -> str:
    ...
    if "potential" in lower:
        return "potential"
    if "orbital" in lower or "mo" in lower or "wf" in lower:
        return "orbital_density"
    return "charge_density"


@register_parser("gpaw", "field3d")
class GPAWField3DProvider:
    """GPAW field3d analysis provider."""
