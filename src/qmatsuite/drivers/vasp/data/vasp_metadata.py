...
def _load_raw_metadata() -> Dict[str, Any]:
    ...
    If ``QMS_VASP_METADATA_HOT_RELOAD=1`` is set, checks file mtime and
    ...
    hot_reload = os.environ.get("QMS_VASP_METADATA_HOT_RELOAD", "").strip() == "1"
    ...
    try:
        ...
        raise FileNotFoundError(
            "vasp_incar_tags.json is missing from qmatsuite.drivers.vasp.data."
        ) from exc
