"""ABINIT field3d analysis provider (cube from cut3d post-processing)."""
...
def _detect_field_kind(name: str) -> str:
    upper = name.upper()
    if "DEN" in upper or "DENSITY" in upper:
...
@register_parser("abinit", "field3d")
class ABINITField3DProvider:
    """ABINIT field3d analysis provider."""
