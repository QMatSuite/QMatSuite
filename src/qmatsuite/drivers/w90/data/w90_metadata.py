...
def _load_raw_metadata() -> Dict[str, Any]:
    ...
    If ``QMS_W90_METADATA_HOT_RELOAD=1`` is set, checks file mtime and
    ...
    hot_reload = os.environ.get("QMS_W90_METADATA_HOT_RELOAD", "").strip() == "1"
    ...
    try:
        ...
        raise FileNotFoundError(
            "w90_tags.json is missing from qmatsuite.drivers.w90.data."
        ) from exc
