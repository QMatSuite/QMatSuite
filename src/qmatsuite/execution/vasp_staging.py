...
if TYPE_CHECKING:
    from qmatsuite.calculation.public import ManifestStepEntry, Step
...
def is_scf_step(step: "Step", registry=None) -> bool:
    ...
    """
    if registry is None:
        from qmatsuite.workflow.public import get_registry
        registry = get_registry()

    from qmatsuite.workflow.public import is_spec
