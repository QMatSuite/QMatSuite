...
class WorkflowService:
    ...
    def detect_workflow(self, calc_dir: Path) -> WorkflowMatch:
        ...
        import logging
        from qmatsuite.core.public import is_resolution_debug_enabled
        ...
        for i, step_entry in enumerate(steps):
            ...
            if step_ulid and project_root:
                try:
                    from qmatsuite.core.public import resolve_step
    ...
    def instantiate_workflow(
        ...
        *,
        ...
        """
        from qmatsuite.workflow.step_factory import create_step_doc, save_step_doc
        from qmatsuite.workflow.generalized_steps import materialize_workflow
        from qmatsuite.core.public import CalculationModel
        ...
        from qmatsuite.core.public import set_calculation_steps
        from qmatsuite.core.public import find_project_root
