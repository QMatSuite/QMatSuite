...
Usage:
    python -m qmatsuite.engines.pyscf job_chain.json
    python -m qmatsuite.engines.pyscf job.json  # Legacy: converted to chain of length 1
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python -m qmatsuite.engines.pyscf <job_chain.json|job.json>", file=sys.stderr)
        sys.exit(3)
