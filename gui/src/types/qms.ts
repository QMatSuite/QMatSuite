/**
 * QMatSuite JSON-RPC Types
 * 
 * These types mirror the daemon protocol defined in
 * src/qmatsuite/daemon/server.py
 * 
 * Uses a centralized QMSCommandMap for end-to-end type safety.
 */
...
export interface QMSResponse<T = unknown> {
  id: string;
  ok: boolean;
  data?: T;
  error?: QMSError;
...
export type QMSCommandType = keyof QMSCommandMap;

/** Get payload type for a command */
export type QMSPayload<K extends QMSCommandType> = QMSCommandMap[K]['payload'];

/** Get result type for a command */
export type QMSResult<K extends QMSCommandType> = QMSCommandMap[K]['result'];

// =============================================================================
// Window API Type (for preload)
// =============================================================================

export interface QMSApi {
  /**
