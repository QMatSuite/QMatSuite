...
export function DemoGalleryPanel({
  ...
  }, [qv.call]); // Use qv.call instead of qv to avoid infinite loop (call is stable)
  ...
  const handleCreateProject = useCallback(async (demo: DemoProjectInfo) => {
    ...
    const parentDir = await window.qv.openDirectory();
  ...
  }, [qv.call, onCreateProject]); // Use qv.call instead of qv to avoid infinite loop
  
  return (
    <div className="demo-gallery-panel" data-testid="qv-demo-gallery-view">
      <div className="demo-gallery-panel__header">
        <button 
          className="demo-gallery-panel__back-btn"
          onClick={onBack}
          data-testid="qv-demo-gallery-back-btn"
        >
          ← Back to Home
        </button>
      ...
      <div className="demo-gallery-panel__content">
        {isLoading ? (
          <div className="demo-gallery-panel__loading" data-testid="qv-demo-gallery-loading">
            <div className="loading-spinner" />
            <p>Loading demo projects...</p>
          </div>
        ) : error ? (
          <div className="demo-gallery-panel__error" data-testid="qv-demo-gallery-error">
          ...
          <div className="demo-gallery-panel__error" data-testid="qv-demo-gallery-empty-state">
            <div className="error-card">
          ...
          <>
            ...
            {createError && (
              <div className="demo-gallery-panel__create-error" data-testid="qv-demo-gallery-create-error">
                <span className="error-icon">⚠️</span>
