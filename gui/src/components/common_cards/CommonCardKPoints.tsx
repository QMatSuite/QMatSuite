...
export const CommonCardKPoints = forwardRef<CommonCardKPointsRef, CommonCardKPointsProps>(({
  ...
  if (isNewCard && !isEditing) {
    return (
      <div className="kpoints-card" data-testid="qms-kpoints-card">
        <div className="kpoints-card__header">
          <span className="kpoints-card__title">K_POINTS</span>
        </div>
        <div className="kpoints-card__empty" data-testid="qms-kpoints-no-card">
  ...
  // Edit mode
  return (
    <div className="kpoints-card kpoints-card--editing" data-testid="qms-kpoints-card">
      <div className="kpoints-card__header">
        <span className="kpoints-card__title">K_POINTS</span>
        <div className="kpoints-card__edit-toggle">
          <button
            ...
            data-testid="qms-kpoints-editor-structured"
          >
            📊 Structured
          </button>
          <button
            ...
            data-testid="qms-kpoints-editor-raw"
          >
            📝 Raw
          </button>
        </div>
      ...
      {isNewCard && (
        <div className="kpoints-card__parse-warning" data-testid="qms-kpoints-new-card-hint">
      ...
      <div className="kpoints-card__content">
        ...
        <div className="kpoints-card__field">
          ...
          <select
            ...
            disabled={useRawEdit}
            data-testid="qms-kpoints-mode-select"
          >
                  ...
                  {['nk1', 'nk2', 'nk3'].map(field => (
                    <div key={field} className="kpoints-card__input-group">
                      ...
                      <input
                        ...
                        min={1}
                        disabled={useRawEdit}
                        data-testid={`qms-kpoints-auto-${field}`}
                      />
                    </div>
                  ))}
                </div>
            ...
            <div className="kpoints-card__points">
              <div className="kpoints-card__points-header">
                ...
                <button
                  ...
                  disabled={useRawEdit}
                  data-testid="qms-kpoints-add-point"
                >
                  + Add Point
                </button>
              </div>
                        ...
                        {(['x', 'y', 'z', 'w'] as const).map(field => (
                          <td key={field}>
                            <input
                              ...
                              disabled={useRawEdit}
                              data-testid={`qms-kpoints-point-${i}-${field}`}
                            />
                          </td>
                        ))}
                        <td>
                          <button
                            ...
                            title="Remove point"
                            disabled={useRawEdit}
                            data-testid={`qms-kpoints-remove-point-${i}`}
                          >
                            ×
                          </button>
                        </td>
        ...
        <div className={`kpoints-card__raw-section ${!useRawEdit ? 'kpoints-card__raw-section--disabled' : ''}`}>
          ...
          <textarea
            ...
            disabled={!useRawEdit}
            readOnly={!useRawEdit}
            data-testid="qms-kpoints-raw-body"
          />
        </div>
