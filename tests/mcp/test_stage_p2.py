...
class TestListAvailableResources:
    ...
    def test_qe_with_si(self, qms_project):
    ...
    def test_qe_default_elements(self, qms_project):
    ...
    def test_vasp(self, qms_project):
    ...
    def test_lammps(self, qms_project):
    ...
    def test_xtb_builtin(self, qms_project):
    ...
    def test_unknown_engine(self, qms_project):
...
class TestAutoResolveSpeciesMap:
    ...
    def test_qe_resolve_si(self, qms_project):
    ...
    def test_qe_resolve_metadata(self, qms_project):
    ...
    def test_bad_ulid(self, qms_project):
    ...
    def test_unsupported_engine(self, qms_project):
...
class TestCreateCalcAutoResolve:
    ...
    def test_auto_resolve_flag(self, qms_project):
    ...
    def test_hint_reflects_auto_resolve(self, qms_project):
...
class TestRunCalcValidation:
    ...
    def test_missing_species_map_error(self, qms_project):
    ...
    def test_run_calculation_accepts_run_mode(self, qms_project):
    ...
    def test_with_species_map_no_validation_error(self, qms_project):
...
class TestInspectResourceStatus:
    ...
    def test_resource_status_present(self, qms_project):
    ...
    def test_resource_status_flags_missing(self, qms_project):
...
class TestContextHints:
    ...
    def test_list_resources_hints(self, qms_project):
    ...
    def test_resolve_species_map_hints(self, qms_project):
