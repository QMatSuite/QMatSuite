...
cd /Users/hh7465/QMatSuite/tests/data/lammps/fixtures
...
thermo 10
dump traj all custom 10 /Users/hh7465/QMatSuite/tests/data/lammps/fixtures/dump_minimize.lammpstrj id type x y z vx vy vz fx fy fz
dump_modify traj sort id
minimize 1.0e-6 1.0e-8 50 500
write_data /Users/hh7465/QMatSuite/tests/data/lammps/fixtures/final_minimize.data
IN
...
thermo 10
dump traj all custom 10 /Users/hh7465/QMatSuite/tests/data/lammps/fixtures/dump_md.lammpstrj id type x y z vx vy vz fx fy fz
dump_modify traj sort id
timestep 0.001
run 100
IN2
