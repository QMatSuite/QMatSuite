...
# NOTE: load_artifact tests REMOVED (Batch 36)
# load_artifact method was removed as it had 0 daemon/CLI usage.
# Tests should access artifacts directly via filesystem instead.
