"""Tests for CP2K field3d parser/provider."""
...
from quantumvitas.drivers.cp2k.parsers.field3d import CP2KField3DProvider

FIXTURE_DIR = Path(__file__).resolve().parents[2] / "data" / "analysis_cp2k_field3d"
