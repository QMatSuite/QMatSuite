...
def _vasp_binary_available() -> bool:
    ...
    from quantumvitas.drivers.vasp.engine.vasp_runner import find_vasp_binary
...
def potcar_library():
    ...
    from quantumvitas.drivers.vasp.engine.vasp_potcar import get_default_potcar_root
