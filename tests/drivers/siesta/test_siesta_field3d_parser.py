"""Tests for Siesta field3d parser/provider."""
...
from quantumvitas.drivers.siesta.parsers.field3d import SiestaField3DProvider

FIXTURE_DIR = Path(__file__).resolve().parents[2] / "data" / "analysis_siesta_field3d"
...
def test_can_parse_true() -> None:
    provider = SiestaField3DProvider()
