"""Unit tests for qmatsuite/api.py - QMSService."""
...
from qmatsuite.core.resolution import SelectorNotFoundError, ResourceNotFoundError


class TestQMSServiceProject:
    """Test QMSService project operations."""

    def test_init_project(self, tmp_path):
        """Initialize a new project."""
        project_dir = tmp_path / "new-project"

        result = QMSService.init_project(project_dir, name="My Project")
    ...
    def test_init_project_default_name(self, tmp_path):
        ...
        QMSService.init_project(project_dir)
    ...
    def test_configure_project(self, tmp_path):
        ...
        QMSService.init_project(project_dir, name="Original Name")
    ...
    def test_init_project_prevents_nested_project(self, tmp_path):
        ...
        QMSService.init_project(parent_project, name="Parent Project")

        # Try to create a project inside the existing project
        nested_dir = parent_project / "nested-project"
        with pytest.raises(ValueError, match="inside an existing QMatSuite project"):
            QMSService.init_project(nested_dir, name="Nested Project")
    ...
    def test_init_project_prevents_creating_in_project_subdir(self, tmp_path):
        ...
        QMSService.init_project(project_dir, name="Test Project")

        # Try to create a project in the structures subdirectory
        structures_dir = project_dir / "structures" / "new-project"
        with pytest.raises(ValueError, match="inside an existing QMatSuite project"):
            QMSService.init_project(structures_dir, name="Nested Project")
    ...
    def test_init_project_allows_tmp_subdir_inside_project(self, tmp_path):
        ...
        result = QMSService.init_project(nested_tmp_dir, name="Nested Tmp Project")

        assert result == nested_tmp_dir
        assert (nested_tmp_dir / "project.qms.yml").exists()
    ...
    def test_create_demo_project_prevents_nested_project(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="inside an existing QMatSuite project"):
            QMSService.create_demo_project(nested_dir, name="Nested Demo")


class TestQMSServiceStructure:
    """Test QMSService structure operations."""
    ...
    def test_import_structure(self, project_with_struct_source):
        ...
        result = QMSService(project_dir).structure.import_file(source_file, name="Silicon")
    ...
    def test_import_structure_unique_name(self, project_with_struct_source):
        ...
        QMSService(project_dir).structure.import_file(source_file, name="Silicon")
        result2 = QMSService(project_dir).structure.import_file(source_file, name="Silicon")
    ...
    def test_list_structures(self, project_with_struct_source):
        ...
        QMSService(project_dir).structure.import_file(source_file, name="Silicon")
        QMSService(project_dir).structure.import_file(source_file, name="Graphene")
    ...
    def test_delete_structure(self, project_with_struct_source):
        ...
        # Import a structure
        result = QMSService(project_dir).structure.import_file(source_file, name="To Delete")
...
class TestQMSServiceCalculation:
    """Test QMSService calculation operations."""
    ...
    def test_init_calculation(self, project):
        ...
        result = QMSService(project).project.init_calculation("My Calculation", engine_family="qe")
    ...
    def test_init_calculation_with_structure(self, project, tmp_path):
        ...
        QMSService(project).structure.import_file(source, name="Silicon")

        result = QMSService(project).project.init_calculation("SCF Calc", structure_selector="silicon", engine_family="qe")
    ...
    def test_list_calculations(self, project):
        ...
        QMSService(project).project.init_calculation("Calculation 1", engine_family="qe")
        QMSService(project).project.init_calculation("Calculation 2", engine_family="qe")
    ...
    def test_get_calculation(self, project):
        ...
        QMSService(project).project.init_calculation("My Calculation", engine_family="qe")
    ...
    def test_configure_calculation_structure(self, project, tmp_path):
        ...
        struct1 = QMSService(project).structure.import_file(source1, name="Silicon1")
        struct2 = QMSService(project).structure.import_file(source2, name="Silicon2")

        # Create calculation with first structure
        calc = QMSService(project).project.init_calculation("Test Calc", structure_selector=struct1.meta.ulid, engine_family="qe")
    ...
    def test_delete_calculation(self, project):
        ...
        calc_resource = QMSService(project).project.init_calculation("To Delete", engine_family="qe")
...
class TestQMSServiceStep:
    """Test QMSService step operations."""
    ...
    def project_with_calculation(self, tmp_path):
        ...
        QMSService(project_dir).project.init_calculation("Test Calculation", structure_selector="silicon", engine_family="qe")
    ...
    def test_init_step_inherits_structure(self, project_with_calculation):
        ...
        from qmatsuite.core.resolution import build_resource_index, require_structure, resolve_calculation
