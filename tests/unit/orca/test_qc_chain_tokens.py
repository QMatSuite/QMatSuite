...
class TestGenTypeTokens:
    ...
    def test_token_mapping_exists(self):
        ...
        from qmatsuite.workflow.registry import GEN_TYPE_TOKENS
...
class TestGetTokenForGenType:
    ...
    def test_get_scf_token(self):
        ...
        from qmatsuite.workflow.registry import get_token_for_gen_type
...
class TestGenerateSubchainBasename:
    ...
    def test_single_scf(self):
        ...
        from qmatsuite.workflow.registry import generate_subchain_basename
...
class TestChainNamespaceFolder:
    ...
    def test_basic_namespace(self):
        ...
        from qmatsuite.workflow.registry import get_chain_namespace_folder
