...
def audit_daemon_imports(daemon_file: Path) -> Dict[str, Any]:
    ...
    # Build statistics
    by_module: Dict[str, Dict[str, Any]] = defaultdict(lambda: {"count": 0, "lines": [], "functions": set()})
    by_symbol: Dict[str, Dict[str, Any]] = defaultdict(lambda: {"count": 0, "lines": [], "functions": set()})
